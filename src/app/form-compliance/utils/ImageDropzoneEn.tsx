    ...
    <div style={{ cursor: 'pointer' }} className='w-32 h-28 rounded-lg text-center pt-1' {...getRootProps()}>
      ...
      {selectedImage.length > 0 ? (
        <div className='flex flex-col justify-center items-center'>
          <Image src={URL.createObjectURL(selectedImage[0])} alt="attach evidence" width={100} height={100} style={{ maxWidth: '100px', maxHeight: '100px' }} />
        </div>
      ) : (
        isDragActive ? <p>Drop the image here...</p> : <p>Attach evidence
